    ...
    for i in range(n):
        ...
        if pk == 'com.zm.sport':
            ...
            if testmodel == '1':
                ...
                wd.write(
                    'adb -s ' + dev + ' shell monkey -p com.zm.sport --monitor-native-crashes --ignore-crashes --pct-syskeys 5 --pct-touch 55 --pct-appswitch 20 --pct-anyevent 20 --throttle 200 -s %random% -v ' + count)  # 选择设备执行monkey
            ...
            print ("请确认待测手机" + name + '-' + model + "未安装com.zm.sport~")
