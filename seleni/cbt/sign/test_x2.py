...
class Py(unittest.TestCase):
    def setUp(self):
        ...
        self.base_url = "https://www.bitcloud-home.com"
    ...
    def login(self, account, password):
        ...
        driver.find_element_by_css_selector('img').screenshot('code_02.png')
        # try:
        #     # 打开并显示图片
        #     img = Image.open('code_02.png')
        #     img.show()
        #     img.close()
        # except:
        #     logger.info('获取验证码失败')
    ...
    def send_mail(self):
        ...
        yag.send(
            to=receiver,
            subject="2212 signed in",
            contents=body,
            # attachments=filename,
        )
        logger.info('2212-send mail')
    ...
    def close_alert_and_get_its_text_02(self):
        try:
            ...
            logger.info('selenium.common.exceptions.UnexpectedAlertPresentException')
            # alert = self.driver.switch_to.alert
            # alert_text = alert.text
            # alert.accept()
            # logger.info(alert_text)
