...
def ocr_fateadm(file_name):
    pd_id = "123335"  # 用户中心页可以查询到pd信息
    pd_key = "oZiA6PHDfBQdOUeCEZOBJjvzGLk1vJ4r"
    app_id = "323335"  # 开发者分成用的账号，在开发者中心可以查询到
    app_key = "leTvYbTUhYht+tkKG7TN2RChAFCup1fI"
    # 识别类型，
